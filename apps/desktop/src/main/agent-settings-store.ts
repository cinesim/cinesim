...
import type { AgentProviderKind, AgentSettings, AgentSettingsUpdate } from "../shared/api";

const DEFAULT_SETTINGS: AgentSettings = {
  version: 1,
  defaultProvider: "claude",
  providers: {
    claude: { executablePath: "", model: "sonnet", permissionMode: "supervised" },
    codex: { executablePath: "", model: "gpt-5.6", permissionMode: "supervised" },
  },
};
