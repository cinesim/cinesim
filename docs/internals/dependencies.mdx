...
| ----------------------------------- | ------------------------------------ | ------------ |
| Fontsource Instrument Sans Variable | Bundled UI and caption typeface      | OFL-1.1      |
| HarfBuzzJS                          | OpenType caption text shaping        | MIT          |
| woff2-encoder                       | Bounded bundled-font decompression   | MIT          |
...
| smol-toml                           | Project manifest parsing             | BSD-3-Clause |
| Commander                           | CLI parsing                          | MIT          |
| Acorn / acorn-jsx                   | Restricted JS and JSX parsing        | MIT          |
